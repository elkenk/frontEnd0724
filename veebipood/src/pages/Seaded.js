...
function Seaded() {
  ...
  return (
    <div>
      ...
      {keel === "ee" &&<div>Leht on eestikeelne</div> }
      { keel === "en" &&<div>This page is in english</div>}
      {keel === "ru" &&<div>эта страница на русском языке</div>}
      ...
      <button onClick={muudaKeelRU} className={keel === "ru" ? "aktiivne-keel" : null}>Rycckii</button>
