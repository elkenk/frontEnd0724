...
function Esindused() {
    // HTMLi muudab ilma URLi muutmata AINULT useState
    ...
    const sorteeriAZ =( ) => {
        ...
        muudaEsindused(esindused.slice()); // .slice kustutab mälukoha, et ei muudaks iseennast, iseenda kaudu
    }
    ...
    <div>
      <div>Tallinna esinduste tähtede arv: {arvutaKokku()}</div>
        ...
        <button className={linn ==="Tallinn" ? "linnAktiivne" : null} onClick={() => muudaLinn("Tallinn")}>Tallinn</button>
        <button className={linn ==="Tartu" ? "linnAktiivne" : null} onClick={() => muudaLinn("Tartu")}>Tartu</button>
        <button className={linn ==="Narva" ? "linnAktiivne" : null} onClick={() => muudaLinn("Narva")}>Narva</button>
        <button className={linn ==="Pärnu" ? "linnAktiivne" : null} onClick={() => muudaLinn("Pärnu")}>Pärnu</button>
